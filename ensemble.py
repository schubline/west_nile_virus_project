...
def CV_test_rig(X,y):
    """
    Tests GridSearchV with VotingClassifier composed of two 
    RandomForestClassifiers
    
    Parameters:
    ----------
    X: predictors, sklearn format
    y: targets, sklarn format
...
"""
Test rig for GridSearch on ensemble classifier, built w/ iris data
"""
